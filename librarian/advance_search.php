						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  $user_query=("select * from book where status != 'Archive' and book_title LIKE  '%$title%'
								  OR status != 'Archive' and author LIKE '%$author%'")or die(mysqli_connect_error());
								  $result = mysqli_query($conn,$user_query);
									...
									$result = mysqli_query($conn,$borrow_details);
									...
									echo $total; */
											$cat_query = ("select * from category where category_id = '$cat_id'")or die(mysqli_connect_error());
