...
<div class="span3">
				...
				<option></option>
				<?php $result =  mysqli_query("select * from member")or die(mysql-_connect_error()); 
						...
						<div class="alert alert-success"><strong>Select Book</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query("select * from book where status != 'Archive' ");
                                  $result = mysqli_query($conn,$user_query);
									while($row=mysqli_fetch_assoc($user_query)){
									$id=$row['book_id'];  
									$cat_id=$row['category_id'];

											$cat_query = mysqli_query("select * from category where category_id = '$cat_id'")or die(mysqli_connect_error());
